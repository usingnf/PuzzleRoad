...
public class Boss_Lazer2 : MonoBehaviour
{
    [SerializeField] private Boss_LazerTrap2 trap;
    ...
    void Update()
    {
        ...
        if (Laser != null && UpdateSaver == false)
        {
            ...
            if (Physics.Raycast(transform.position, transform.TransformDirection(Vector3.forward), out hit, MaxLength, LayerMask.GetMask("Default", "Ground", "Player")))//CHANGE THIS IF YOU WANT TO USE LASERRS IN 2D: if (hit.collider != null)
            {
